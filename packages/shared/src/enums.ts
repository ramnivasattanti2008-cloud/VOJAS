...
export enum AuditAction {
  ...
  ANOMALY_NOTE_ADDED = 'ANOMALY_NOTE_ADDED',
  ANOMALY_INFO_REQUESTED = 'ANOMALY_INFO_REQUESTED',
  ANOMALY_INSPECTION_REQUESTED = 'ANOMALY_INSPECTION_REQUESTED',
  ANOMALY_CONTRACTOR_RESPONSE_REQUESTED = 'ANOMALY_CONTRACTOR_RESPONSE_REQUESTED',
  ANOMALY_VERIFIED = 'ANOMALY_VERIFIED',
  ANOMALY_REOPENED = 'ANOMALY_REOPENED',
  ANOMALY_EVIDENCE_LINKED = 'ANOMALY_EVIDENCE_LINKED',
  FIELD_VERIFICATION_SCHEDULED = 'FIELD_VERIFICATION_SCHEDULED',
  FIELD_VERIFICATION_COMPLETED = 'FIELD_VERIFICATION_COMPLETED',
  CONTRACTOR_UPDATE_REVIEWED = 'CONTRACTOR_UPDATE_REVIEWED',
  HIGH_RISK_MILESTONE_OVERRIDE = 'HIGH_RISK_MILESTONE_OVERRIDE',
  // Phase 4: Enforcement Referral
