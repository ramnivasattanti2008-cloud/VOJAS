...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  return (
    <AuthGate>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[#007AFF] focus:text-white focus:rounded-[10px] focus:shadow-ios-floating focus:ring-2 focus:ring-[#007AFF]/40"
      >
