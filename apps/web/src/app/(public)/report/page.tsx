        ...
        <Card>
          <CardBody className="py-12 text-center">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Save this reference number to track your report status. You can also sign up for
              updates if you provided your email.
            </p>
        ...
        <CardBody className="flex gap-3">
          ...
          <div className="text-sm text-blue-800">
            ...
            <ul className="list-disc list-inside space-y-0.5 text-blue-700">
              ...
              <li>Media metadata is stripped before public display unless you choose otherwise</li>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Choose who can see your report and identity
            </p>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-slate-500 mt-1">Select the category that best describes your report</p>
          </CardHeader>
          <CardBody>
        ...
        <Card>
          ...
          <CardBody className="space-y-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                placeholder="Describe what you observed in detail. Include dates, locations, and any people involved. Be factual and objective."
              ...
              <>
                {formData.latitude && formData.longitude && (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-sm">
                    ...
                    {formData.locationAccuracyM && (
                      <p className="text-green-600 text-xs mt-1">
                        Accuracy: ±{Math.round(parseFloat(formData.locationAccuracyM))}m
                      </p>
                    )}
                  </div>
                )}
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Optional. We may contact you for more information.
            </p>
          </CardHeader>
          <CardBody className="space-y-4">
            <label className="flex items-center gap-2 text-sm text-slate-600 cursor-pointer">
            ...
            {formData.isAnonymous && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-sm text-amber-800">
                ...
                Your report will be submitted anonymously. We cannot contact you for follow-up.
              </div>
            )}
          </CardBody>
        </Card>
