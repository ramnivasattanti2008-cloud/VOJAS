...
export const metadata: Metadata = {
  ...
  description: 'Explore MPLAD projects, submit reports, and monitor fund accountability in your constituency.',
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-4 flex-wrap justify-end">
            <Link href="/explore" className="text-sm font-medium text-slate-600 hover:text-slate-900">
              Explore Projects
            </Link>
      ...
      <footer className="border-t border-slate-200 bg-white mt-auto">
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-4 text-sm text-slate-500">
